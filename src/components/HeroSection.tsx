    ...
    <div className='mt-10 flex flex-col gap-10 lg:mt-0 2xl:mt-3'>
       <section className='flex flex-col gap-5 md:border md:border-[#222] md:rounded-xl md:p-10 lg:gap-8 lg:rounded-2xl xl:gap-5 xl:p-12 2xl:p-16'>
        ...
        <div className='flex gap-4 text-sm xs:mt-3 xs:gap-6 2xl:text-lg 2xl:gap-8'>
          ...
          <button className='flex overflow-hidden pr-5 p-3 px-4 bg-white rounded-md shadow-2xl cursor-pointer items-center shadow-light gap-2 relative before:absolute before:right-0 before:w-[7px] before:h-full before:bg-violet-dark xs:px-6 xl:gap-3 2xl:px-8 2xl:py-4'>
