  ...
  return (
    <footer className={`${theme === "Dark" ? "bg-[#222]" : "bg-dark"} mt-16 pt-10 text-white text-center text-sm xs:text-base xl:text-lg 2xl:text-[1.4em] 2xl:pt-16 2xl:mt-32`}>
        ...
        <div className='flex justify-center gap-5 items-center 2xl:gap-8'>
            <img className='w-5 2xl:w-7' src={instagramIcon} alt="" />
            <img className='w-5 2xl:w-7' src={facebookIcon} alt="" />
            <img className='w-5 2xl:w-7' src={linkedinIcon} alt="" />
        </div>
        </div>

        <div className='bg-violet-dark mt-10 text-xs py-3 xs:text-sm xl:text-base 2xl:mt-16 2xl:text-[.95em]'>
